        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Movies_Categories_HomeId",
                        column: x => x.HomeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviesSubimages", x => x.ID);
                    table.ForeignKey(
                        name: "FK_MoviesSubimages_Movies_MovieID",
                        column: x => x.MovieID,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Movies_HomeId",
                table: "Movies",
                column: "HomeId");

            migrationBuilder.CreateIndex(
                name: "IX_MoviesSubimages_MovieID",
                table: "MoviesSubimages",
                column: "MovieID");
        }
